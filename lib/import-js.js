...
function importWord() {
  ...
  const result = inCurrentWorkingDirectory(() => getImporter().import(word));
...
function fixImports() {
  ...
  allowUnsafeNewFunction(() => {
    result = inCurrentWorkingDirectory(() => getImporter().fixImports());
  });
  handleImporterResult(result);
}
...
function gotoWord() {
  ...
  const result = inCurrentWorkingDirectory(() => getImporter().goto(word));
